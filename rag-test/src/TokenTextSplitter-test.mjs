...
    encodingName: 'cl100k_base',  // qwen-plus 模型使用的tokenizer different AI model has deifferent tokenization rules, so you need to specify the encoding name that matches your model 
  });
